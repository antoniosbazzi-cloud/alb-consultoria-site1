        ...
        <div className="container mx-auto text-center max-w-5xl">
          ...
          <div className="bg-gradient-to-r from-primary to-secondary text-white rounded-3xl p-8 mb-12 shadow-2xl">
            ...
            >
              <Button
                size="lg"
                className="bg-white text-primary hover:bg-gray-100 text-2xl px-16 py-8 rounded-full shadow-2xl hover:shadow-3xl transition-all duration-300 transform hover:scale-105 font-bold"
              >
        ...
        <div className="container mx-auto text-center max-w-4xl">
          <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12 border border-gray-100">
            ...
            >
              <Button
                size="lg"
                className="bg-gradient-to-r from-primary to-secondary hover:from-blue-700 hover:to-orange-600 text-white text-xl px-12 py-6 rounded-full shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105 font-bold"
              >
        ...
        <div className="container mx-auto text-center max-w-4xl">
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center items-center mb-8">
            ...
            >
              <Button
                size="lg"
                className="bg-white text-primary hover:bg-gray-100 text-xl px-12 py-6 rounded-full shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105 font-bold"
              >
                <MessageCircle className="h-6 w-6 mr-3" />
                FALAR NO WHATSAPP
              </Button>
            ...
            <Link href={`tel:${whatsappNumber}`}>
              <Button
                size="lg"
                variant="outline"
                className="border-2 border-white text-white hover:bg-white hover:text-primary text-xl px-12 py-6 rounded-full shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105 bg-transparent font-bold"
              >
